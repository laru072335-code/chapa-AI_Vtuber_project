...
os.environ["OMP_NUM_THREADS"] = "1"#この項目は、analyze_emotionを実行するときに設定が必要
os.environ["MKL_NUM_THREADS"] = "1"#この項目は、analyze_emotionを実行するときに設定が必要
# 読み込み
stopword =["こと","もの","とき","ところ","ひと","自分","問題","考え","気持ち","理由","方法","目的","場合","結果","変化","状態","事実","意味","内容","関係","程度","種類","全体","一部","一般","違い","能力","効果","役割","印象","可能性","必要","習慣","基本","中心","対象","原則","これ","それ","あれ","ここ","そこ","あそこ","日","月","年","今日","明日","昨日","時間","午前","午後","今","前","後","中","数","回","分","度","現在","過去","未来","最初","最後","単位","量","率","ゼロ","一番","上","下","右","左","前","後ろ","外","内","場所","方","家","道","横","隅","奥","側","体","手","目","口","頭","生活","仕事","お金","食事","水","空気","声","名前","年齢","社会","国","会社","店","駅","会議","システム","サービス","ニュース","原因","規則","決定","計画","活動","経験","意見","光","音","色","味","匂い","温度","力","形","天","地","風","雨","雪","文","話","言葉","文字","質問","答え","説明","表現","逆","等身","枚数","出身","目標","様子","人","時","ため","内容","分野","部門","企業","概要","今回","日","土曜","今日","最近","年代","世紀","年","last","邦題","名義","名称","主人","ひとり","二人","少年","両親","子孫","一人","おなか","サイト","雑貨","作品","登場","提供","原料","添加","語","並","使い","元気","今","暇","話題","タイトル","元気","友達","テンション","ちょうだい","頂戴","笑","草","理解","他","初見","ｗ","ｗｗ","都","府","県","注意"]#汎用性の高すぎる名詞←これがキリないからどうするか考えたい。
check= False
tagger =None
load_dotenv('.env')
depth=0
